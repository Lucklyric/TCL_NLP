...
def prepare_tcl_data(data_dir):
    in_vocab_path = os.path.join(data_dir, ".in")
    ner_vocab_path = os.path.join(data_dir, ".ner")
    create_vocabulary(in_vocab_path, os.path.join(data_dir, "train_raw.txt"))
    create_vocabulary(ner_vocab_path, os.path.join(data_dir, "train.text.txt"))
